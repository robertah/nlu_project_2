...
def pos_tag_dataset(dataset):
    """
    Saves two files containing an array of size #stories/rows by 5 (story id, sen1 to sen4) for the former
    and an array of size #stories/rows by 2 (story id, sen5).
