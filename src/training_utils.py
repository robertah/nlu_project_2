...
def batches_pos_neg_endings(neg_aug_obj, data, total_stories, is_w2v, merge_sentences, batch_size = 2):
    """INPUT:
...
def batch_iter_train_cnn(data, neg_aug_obj, is_w2v, merge_sentences, 
    ...
    for i in range(0,num_epochs):
        ...
        aug_data, ver_aug_data= batches_pos_neg_endings(neg_aug_obj = neg_aug_obj, data = data, merge_sentences = merge_sentences,
                                         is_w2v = True, batch_size = batch_size, total_stories = total_stories)
